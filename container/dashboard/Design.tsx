...
const Design = (props: {
  ...
  const handleSaveButton = async (e: any) => {
    ...
    await senDataToServer({ avatar: props.image, username: props.nameProfile, bio: props.bioProfile});
    props.getUser();
  };
      ...
      <div className="mt-9 bg-white px-9 py-9 w-full">
        ...
        <div className="flex gap-[50px] mt-6">
          ...
          <div className="flex flex-col">
            <div className="w-[149px] h-[87.84px] mb-2 bg-[#f3f3f4] relative border rounded-lg">
            ...
            <Checkbox onChange={onChangeTop} checked={iconInTop}>Top</Checkbox>
          </div>
          <div className="flex flex-col">
            <div className="w-[149px] h-[87.84px] bg-[#f3f3f4] mb-2 relative border rounded-lg">
            ...
            <Checkbox onChange={onChangeBottom} checked={iconInBottom} >Bottom</Checkbox>
          </div>
        </div>
      </div>
      <div className="px-7 bg-white mb-2">
